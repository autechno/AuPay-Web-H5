<template>
  <div class="page" style="padding-top: 28px;">
      ...
      <div class="table-list">
        ...
        <div class="text"><span><el-image :src="peo" />用户信息</span><el-icon><ArrowRightBold /></el-icon></div>
        <div class="text"><span><el-image :src="editSquare" />申请/审批</span><el-icon><ArrowRightBold /></el-icon></div>
        <div class="text"><span><el-image :src="add" />地址管理</span><el-icon><ArrowRightBold /></el-icon></div>
